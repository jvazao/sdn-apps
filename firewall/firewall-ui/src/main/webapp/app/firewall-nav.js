...
(function (api) {
    ...
    f.trace('including firewall-nav.js');

    // Add a new category and new item
    nav.insertCategoryAfter('c-tasks', 'c-firewall', [
        nav.item('n-firewall', 'firewall', 'square')
    ]);

    // Add a new item to an existing category
    nav.insertItemsBefore('n-exportLogs', [
        nav.item('n-firewall-task', 'firewallTask', 'square')
    ]);
