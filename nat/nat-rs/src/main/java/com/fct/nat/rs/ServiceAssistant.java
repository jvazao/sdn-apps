...
@References(value={
    @Reference(name="NATService", 
               referenceInterface=com.fct.nat.api.NATService.class,
...
public class ServiceAssistant {
    ...
    /**
     * Hook for registering NATService implementation via declarative services.
     *
     * @param s newly advertised service to register
     * @param properties the properties associated with the service
     */
    protected void bindNATService(com.fct.nat.api.NATService s, Map<String, Object> properties) {
        sl.register(com.fct.nat.api.NATService.class, s, properties);
    }
     ...
     */
    protected void unbindNATService(com.fct.nat.api.NATService s) {
        sl.unregister(com.fct.nat.api.NATService.class, s);
    }
