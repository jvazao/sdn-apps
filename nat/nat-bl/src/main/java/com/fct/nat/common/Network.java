...
public class Network {
	...
	public final static DataPathId SDN_DPID_HP1 = DataPathId.valueOf("00:02:64:51:06:b4:37:40"); //TODO rename to HP1
	...
	// STAFF Network
	public final static IpAddress STAFF_NETWORK = IpAddress.valueOf("10.164.24.0");
	public final static IpAddress STAFF_MASK = IpAddress.valueOf("255.255.252.0");
	public final static IpRange STAFF_DOMAIN = IpRange.valueOf("10.164.24-27.0-255");
	public final static IpAddress STAFF_DNS_IP = IpAddress.valueOf("10.130.16.33");
	public final static IpAddress STAFF_DNS2_IP = IpAddress.valueOf("10.130.16.34");
	public final static IpAddress STAFF_DHCP_SERVER = IpAddress.valueOf("10.164.24.1");
	public final static IpAddress STAFF_GATEWAY_IP = IpAddress.valueOf("10.164.24.1");
	public final static MacAddress STAFF_GATEWAY_MAC = MacAddress.valueOf("00:12:80:c8:e6:c3");
	public final static VlanId STAFF_VLAN = VlanId.vlan(4);
