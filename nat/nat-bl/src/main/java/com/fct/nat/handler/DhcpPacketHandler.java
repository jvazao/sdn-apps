...
public class DhcpPacketHandler {
	...
	/**
	 * Constructs a DHCP Discovery packet on behalf of the SVI to the DHCP server on 
	...
	public void discovery() {
		...
		DhcpOption[] options = {
				...
				new DhcpOption(DhcpOption.Code.ADDR_LEASE_TIME, 7776000), // 90 days
	...
	/**
	 * Based on the DHCP OFFER it constructs a DHCP REQUEST and sends it back to the DHCP server
	 * 
	 * */
